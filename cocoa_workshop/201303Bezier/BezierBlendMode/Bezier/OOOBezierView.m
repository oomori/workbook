...
- (void)drawRect:(CGRect)rect
{
    ...
    [outPath2 addArcWithCenter:CGPointMake(currentPosition.x,currentPosition.y) radius:200.0 startAngle:0 endAngle:radians(360) clockwise:YES];
    ...
    UIBezierPath *outPath3 = [UIBezierPath bezierPath];
    [outPath3 moveToPoint:CGPointMake(currentPosition.x-100, currentPosition.y)];
    [outPath3 addLineToPoint:CGPointMake(currentPosition.x+100, currentPosition.y)];
    
    [[UIColor orangeColor] setFill];
    [outPath3 moveToPoint:CGPointMake(currentPosition.x, currentPosition.y)];
    [outPath3 addArcWithCenter:CGPointMake(currentPosition.x,currentPosition.y+200) radius:50.0 startAngle:0 endAngle:radians(360) clockwise:YES];
    
    [outPath3 fillWithBlendMode:(CGBlendMode)kCGBlendModeSourceAtop alpha:0.8];
