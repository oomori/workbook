...
class ViewController: NSViewController,NSDrawerDelegate {
    ...
    @IBAction func function001(sender: AnyObject) {
        ...
        let textField : NSTextField = NSTextField(frame: NSMakeRect(10.0, 10.0, 50.0, 30.0))
    ...
    func buttonAction004_top(sender: AnyObject){
        //var theWindow : NSWindow = (sender as! NSButton).window!
        theDrawer004.openOnEdge(NSRectEdge.MaxX)//上
    }
    func buttonAction004_down(sender: AnyObject){
        //var theWindow : NSWindow = (sender as! NSButton).window!
        theDrawer004.openOnEdge(NSRectEdge.MinX)//下
    }
    func buttonAction004_left(sender: AnyObject){
        //var theWindow : NSWindow = (sender as! NSButton).window!
        theDrawer004.openOnEdge(NSRectEdge.MinY)//左
    }
    func buttonAction004_right(sender: AnyObject){
        //var theWindow : NSWindow = (sender as! NSButton).window!
        theDrawer004.openOnEdge(NSRectEdge.MaxX)//右
    }
    ...
    @IBAction func function004(sender: AnyObject) {
        ...
        //ボタンを作成
        let theButton1 : NSButton = NSButton(frame: NSMakeRect(100.0, 80.0, 100.0, 30.0))
        theButton1.title = "Toggle"
        theButton1.bezelStyle = NSBezelStyle.RoundedBezelStyle
        ...
        let theButton2 : NSButton = NSButton(frame: NSMakeRect(100.0, 168.0, 100.0, 30.0))
        ...
        let theButton3 : NSButton = NSButton(frame: NSMakeRect(100.0, 0.0, 100.0, 30.0))
        ...
        let theButton4 : NSButton = NSButton(frame: NSMakeRect(0.0, 80.0, 100.0, 30.0))
        ...
        let theButton5 : NSButton = NSButton(frame: NSMakeRect(200.0, 80.0, 100.0, 30.0))
