...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    for (UITouch *touch in touches) {
        ...
        SKPhysicsBody *pbody = [SKPhysicsBody bodyWithRectangleOfSize: wheel.frame.size ];
        //SKPhysicsBody *pbody = [SKPhysicsBody bodyWithEdgeChainFromPath: wheel.path ];
        //スプライトの物理ボディをセット
        wheel.physicsBody = pbody ;
        //アクション実行
