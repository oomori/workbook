...
- (void)drawRect:(CGRect)rect {
    ...
    id paragraphStyleAttr = ((^ {
        ...
        //属性辞書
    NSDictionary *fontAttributes1 = @{@"NSFont": (__bridge id)aFont1,
                                    @"CTForegroundColor": (__bridge id)darkGrayColor,
                                     @"CTVerticalForms": @YES,
                                     (__bridge id)kCTLigatureAttributeName: @YES,
                                     (__bridge id)kCTParagraphStyleAttributeName: paragraphStyleAttr};
    
    //属性辞書
    NSDictionary *fontAttributes2 = @{@"NSFont": (__bridge id)aFont2,
                                    @"CTForegroundColor": (__bridge id)redColor,
                                    @"CTVerticalForms": @YES,
    ...
    CTFrameRef frame = CTFramesetterCreateFrame(framesetter, CFRangeMake(0, 0), path, 
                                                (__bridge CFDictionaryRef)@{@"CTFrameProgression": [NSNumber numberWithUnsignedInt:kCTFrameProgressionRightToLeft]});
